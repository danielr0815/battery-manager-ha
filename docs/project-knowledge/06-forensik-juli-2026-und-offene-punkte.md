...
| **F4** Freeze-Guard | v0.16.0 | G2-Latch für rec-only-Lasten erreichbar + 6-h-Telemetrie-Freeze-Wächter (SOC UND Leistung exakt unverändert trotz aktiver Empfehlung). Anlass: Fossibot B2 4 Tage eingefroren (95 h exakt 144 W), Phantom-Planung ohne Warnung | `FREEZE_STALE_HOURS`, `_update_telemetry_freeze` |
