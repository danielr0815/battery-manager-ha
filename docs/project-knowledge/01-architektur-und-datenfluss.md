...
| `entity.py` | Gemeinsame Basisklasse mit `DeviceInfo` (sw_version aus dem Manifest) und der Subentry-Zuordnungshilfe `async_add_by_subentry` (v0.7.19: Entities werden mit ihrer Subentry gelöscht). | `BatteryManagerEntity`, `async_add_by_subentry` |
