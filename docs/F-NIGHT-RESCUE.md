...
> SOC peak only. The rt-honest c1 factor, the merge-bounded threshold search
> and the crossover buffer ramp below are UNCHANGED (and reused by the block
> pass and by energy-limited pass 2).
