...
class Battery:
    ...
    def usable_capacity_wh(self) -> float:
        ...
        return ((self.max_soc_percent - self.min_soc_percent) / 100.0) * self.capacity_wh
    ...
    def charge_discharge(self, requested_energy_wh: float) -> float:
        ...
        if requested_energy_wh > 0:
            ...
            actual_charge_wh = min(requested_energy_wh * self.charge_efficiency, max_charge_wh)
    ...
    def simulate_charge_discharge(self, requested_energy_wh: float) -> tuple[float, float]:
